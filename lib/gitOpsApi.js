...
module.exports = {
	 ...
	 * @return {Promise} When the operation completes successfully, the resolved value is an array of objects.
	 * Each object contains the information of a file in a structure of:
	 * {name: {String}, path: {String}, sha: {String}, size: {Number}, url: {String},
 	 * html_url: {String}, git_url: {String}, download_url: {String}, type: {String},
	 ...
	 * @param {String} content - Optional. The file content. Can be omitted when deleting the corresponding file.
