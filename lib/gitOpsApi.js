...
module.exports = {
	...
	/**
	 * An object that contains required information for fetching a file.
	 * @typedef {Object} GetDirInfoOptions
	 * @param {String} repoOwner - The repo owner.
	 * @param {String} repoName - The repo name.
	...
	/**
	 * An object that contains a directory information.
	 * See https://docs.github.com/en/rest/reference/repos#get-repository-content--code-samples
	 * @typedef {Object} DirInfoResult
	 * @param {String} type - The content type. if the content is a directory, the value is "file".
	 * @param {Number} size - The content size.
	 * @param {String} name - The directory name.
	 * @param {String} path - The directory path.
	 * @param {String} sha - The sha value.
	 * @param {String} url - The github API URL for this directory.
	 * @param {String} git_url - The git data URL for this directory.
	 * @param {String} html_url - The github html URL for this directory.
	 * @param {String} download_url - The github download URL for its raw user content.
	 * @param {Object} _link - Various URLs for this content.
	 * @param {String} _link.self - The github API URL for this directory.
	 * @param {String} _link.git - The git data URL for this directory.
	 * @param {String} _link.html - The github html URL for this directory.
	 */

	/**
	 * Returns all file and directory information, including file names, sizes, urls etc, of a directory.
	 * @param {Object} octokit - An instance of octokit with authentication being set.
	 * @param {GetDirInfoOptions} options - Required parameters for this github operation.
	 * @return {Promise<DirInfoResult[]>} When the operation completes successfully, the resolved value is an array of
	 * directory information. When the operation fails, the promise rejects with an object in a structure of
	 * {isError: true, message: [error-message]};
	 */
	getDirInfo: async (octokit, options) => {
		try {
			...
			throw {
				isError: true,
				message: "Error at getDirInfo(): " + e.message
			};
		}
	},
	...
	/**
	 * An object that contains required information for deleting a single existing file.
	 * @typedef {Object} DeleteSingleFileOptions
	 * @param {String} repoOwner - The repo owner.
	 * @param {String} repoName - The repo name.
	 * @param {String} branchName - The name of the remote branch to operate.
	 * @param {String} filePath - The location of the file including the path and the file name.
	 ...
	 * @param {Object} octokit - An instance of octokit with authentication being set.
	 * @param {DeleteSingleFileOptions} options - Required parameters for this github operation.
	 * @return {Promise} The resolve or reject of the promise indicates whether the operation completes successfully or
	 * unsuccessfully. When successful, the resolved value is a string with the success message. When failed, rejects
	 * with an object in a structure of: {isError: true, message: {error-message}}
	 */
	deleteSingleFile: async (octokit, options) => {
		try {
			...
			return options.filePath + " has been deleted successfully.";
		} catch(e) {
			throw {
				isError: true,
				message: "Error at deleteSingleFile(): " + e.message
			};
		}
	},

	/**
	 * An object that contains file information for it to be added/removed from the GitHub repository.
	 * @typedef {Object} fileObject
	 * @param {String} path - The file path.
	 * @param {String} content - Optional. The file content. Should be omitted when deleting the corresponding file.
	 * This value must be set when adding or updating the file.
	 * @param {String} operation - Optional. Set the value to "delete" when deleting the corresponding file.
	 * When the value is omitted, the corresponding file is considered to be added or updated.
	 */
	...
	commitMultipleFiles: async (octokit, options) => {
		...
		try {
			const blobs = await Promise.all(files.map(file => {
				return file.operation === "delete" ? null :
			...
			const newTree = await octokit.request("POST /repos/{owner}/{repo}/git/trees", {
				...
				tree: files.map((file, index) => {
					return {
						...
						mode: "100644",
						type: "blob",
						sha: blobs[index] === null ? null : blobs[index].data.sha
					};
				}),
